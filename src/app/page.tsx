      ...
      <section className="relative min-h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-30 h-screen flex flex-col items-center justify-center px-4">
          ...
          >
            ...
            <span 
              className="absolute -top-10 left-0 text-5xl md:text-6xl font-black tracking-[-0.01em] bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent"
            >
              SurfHub
            </span>
